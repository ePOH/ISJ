<%@ Page Language="VB" MasterPageFile="MasterPage2.master" AutoEventWireup="false" CodeFile="projects_active_parish.aspx.vb" Inherits="projects_active_parish" %>
...
<div class="sub-header">
  <div class="main">
    <div class="section">
      <h1>ACTIVE PROJECTS IN <asp:Label ID="lb_projects_parish" runat="server" Text=""></asp:Label></h1>
    </div>
  </div>
</div>
...
<div class="whiteSpace">
  <div class="main">
    ...
    <asp:SqlDataSource ID="SQL_DS_Projects_Active" runat="server" ConnectionString="<%$ ConnectionStrings:ConnISJ %>" 

        
        SelectCommand="SELECT Project_ID, Project_Short_Name, Project_Image, Project_Goal, Project_Raised, Project_Type FROM Project_Data_File WHERE (Project_Status = 1) AND (Project_Parish = @param)  AND (Project_Type = 1)  ORDER BY Project_Name">
        <SelectParameters>
