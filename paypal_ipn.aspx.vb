...
Partial Class paypal_ipn
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If strResponse = "VERIFIED" And Request("receiver_email") = "isupportjamaica@jnbs.com" Then
            ...
            For i = 1 To Request("num_cart_items")
                ...
                If Request("payment_status") = "Completed" Then  '' Or Request("payment_status") = "Processed"
                    ...
                    strSQL1 += " IF @@ROWCOUNT>0 "
                    strSQL1 += "UPDATE Project_Data_File SET Project_Status = '2' WHERE (Project_ID = " & P_ID & ") and  Project_Raised >= Project_Goal"
                Else
    ...
    Protected Sub sendmiltoyuer()
        ...
        sMsg = "Hi " & Request("first_name") & " " & Request("last_name") & "," & vbCrLf & "<br/> <br/>"
        sMsg += "" & vbCrLf & ""
        ...
        Try
            ...
            EmailManager.SendEmail(sMsg, "I Support Jamaica Payment confirmation.", Request("payer_email"), Request("first_name") & " " & Request("last_name"), "I Support Jamaica Team <ISupportJamaica@jnbs.com>", bcc)
