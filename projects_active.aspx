<%@ Page Language="VB" MasterPageFile="MasterPage2.master" AutoEventWireup="false" CodeFile="projects_active.aspx.vb" Inherits="projects_active" %>
...
<div class="whiteSpace">
  <div class="main">
    ...
    <asp:SqlDataSource ID="SQL_DS_Projects_Active" runat="server" 
        ...
        SelectCommand="SELECT Project_ID, Project_Short_Name, Project_Slug, Project_Image, Project_Goal, Project_Raised FROM Project_Data_File WHERE (Project_Status = 1) AND (Project_Type = 1) ORDER BY Project_Name">
    </asp:SqlDataSource>
 		</div>
	</div>
</section> 
