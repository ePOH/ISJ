                    ...
                    <ItemTemplate>
                         <div class="img-thumbnail col-md-3" style="width: 280px; min-height: 440px; border-radius:4px !important; padding:3px;">
                            ...
                            <div>
                                ...
                                <img class="seal-image-holder" data-value="<%# Eval("Project_AddSeal").ToString().ToLower() %>" src="images/Seal2_blank.png" style="width:70px; height:70px; margin-top:-70px; margin-left:200px;" />
                            </div>
                              ...
                              SlideShowServiceMethod="GetSlides" AutoPlay="true" Loop="true"  UseContextKey='true' ContextKey='<%# eval("Project_ID") %>' >
                                    ...
                                    <div style="margin-top:-15px;">
                                        ...
                                        <div style="text-align:center; margin-top:15px; margin-bottom:10px;">
                                            <a class="btn-givenow" href="project_details.aspx?pid=<%# Eval("Project_ID") %>">Give Now</a>
                                        </div>
                                    </div>   
                                    <div class ="row">
                                        <div class="col-md-12">
