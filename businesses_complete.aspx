<%@ Page Language="VB" MasterPageFile="MasterPage2.master" AutoEventWireup="false" CodeFile="businesses_complete.aspx.vb" Inherits="businesses_complete" %>
...
<div class="whiteSpace">
  <div class="main">
    ...
    <asp:SqlDataSource ID="SQL_DS_Projects_Complete" runat="server" 
        ...
        SelectCommand="SELECT Project_ID, Project_Short_Name, Project_Image, Project_Goal, Project_Raised FROM Project_Data_File WHERE (Project_Status = 2) AND (Project_Type = 2) ORDER BY Project_Name">
    </asp:SqlDataSource>
