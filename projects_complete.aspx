<%@ Page Language="VB" MasterPageFile="MasterPage2.master" AutoEventWireup="false" CodeFile="projects_complete.aspx.vb" Inherits="projects_complete" %>
...
<!-- begin repeating region for projects -->
          ...
          <asp:ListView ID="ListView1" runat="server" 
                DataSourceID="SQL_DS_Projects_Complete">
                <LayoutTemplate>
...
<div class="whiteSpace">
  <div class="main">
    ...
    <asp:SqlDataSource ID="SQL_DS_Projects_Complete" runat="server" 
        ...
        SelectCommand="SELECT Project_ID, Project_Short_Name, Project_Slug, Project_Image, Project_Goal, Project_Raised FROM Project_Data_File WHERE ((Project_Status = 2) or (Project_Status = 3)) AND (Project_Type = 1) ORDER BY Project_Name">
    </asp:SqlDataSource>
