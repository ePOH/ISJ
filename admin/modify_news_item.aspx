<%@ Page Language="VB" MasterPageFile="ISJAdmin.master" AutoEventWireup="false" CodeFile="modify_news_item.aspx.vb" Inherits="admin_modify_news_item" %>
    ...
    <div class="section">
        <div style="float:left; position:relative; width:800px;">
            ...
            <div style="float:left; position:relative; width:650px;">
                <asp:TextBox ID="Text_News_Channel" runat="server" Width="100%"></asp:TextBox>
            </div>
        </div>
        <div style="float:left; position:relative; width:800px; padding-top:10px;">
            <div style="float:left; position:relative; width:150px;">
                &nbsp;
            </div>
            <div style="float:left; position:relative; width:650px;">
                <asp:Button ID="Button_Save_News_Channel" runat="server" Text="Update Channel" />
            </div>
        </div>
    </div>
  </div>
