<%@ Page Language="VB" MasterPageFile="ISJAdmin.master" AutoEventWireup="false" CodeFile="delete_news_item_text.aspx.vb" Inherits="admin_delete_news_item_text" %>
      ...
      <div class="genericColumn">
        <div class="article">
          ...
          <asp:FormView ID="FV_Add_News" runat="server" DataKeyNames="News_ID" 
            DataSourceID="SQL_DS_News" DefaultMode="Edit" 
            ...
            <EditItemTemplate>
                <table style="width:100%;">
                    ...
                    Text='<%# Bind("News_Date", "{0:dd/MM/yyyy}") %>' />
                ...
                <asp:CalendarExtender ID="News_DateTextBox_CalendarExtender" runat="server" 
                    Enabled="True" TargetControlID="News_DateTextBox" TodaysDateFormat="dd/MM/yyy" DaysModeTitleFormat="MMMM, yyyy" Format="dd/M/yyyy">
                    ...
                    <tr>
                        ...
                        <td class="style4tb">
                            ...
                            &nbsp;</td>
                        <td class="style5tb">
                            <asp:DropDownList ID="News_StatusTextBox" runat="server" 
                    DataSourceID="SQL_DS_News_Status" DataTextField="News_Status" 
                    DataValueField="News_Status_ID" SelectedValue='<%# Bind("News_Status") %>' AppendDataBoundItems="True">
                </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td class="style1tb">
                    ...
                    <tr>
                        ...
                        <td class="style4tb">
                            ...
                            &nbsp;</td>
                        <td class="style5tb">
                            <asp:HiddenField ID="News_ImageTextBox1" Value='<%# Bind("News_Image") %>' runat="server" />
                            ...
                            <asp:HiddenField ID="News_ID"  Value='<%# Bind("News_ID") %>' runat="server" />
            ...
            <InsertItemTemplate>
                ...
                <asp:CalendarExtender ID="News_DateTextBox_CalendarExtender" runat="server" 
                    ...
                    <tr>
                        <td class="style1tb">
                            <asp:HyperLink ID="HL_Delete_News" runat="server">Delete News Item</asp:HyperLink></td>
                        <td class="style4tb">
                            Article Name:</td>
                            <td class="style2tb">
                            <asp:RequiredFieldValidator ID="News_TitleTextBox_RequiredFieldValidator" runat="server" 
  ...
  <div class="main">
    <div class="section">
      <p>&nbsp;</p>
        ...
        DeleteCommand="DELETE FROM [News_Data_File] WHERE [News_ID] = @original_News_ID" 
        OldValuesParameterFormatString="original_{0}" 
        SelectCommand="SELECT * FROM [News_Data_File] WHERE (News_ID = @param)" 
        ...
        UpdateCommand="UPDATE [News_Data_File] SET [News_Date] = @News_Date, [News_Title] = @News_Title, [News_Image] = @News_Image, [News_Body] = @News_Body, [News_Mod_Date] = @News_Mod_Date, [News_Mod_By] = @News_Mod_By, [News_Status] = @News_Status WHERE [News_ID] = @original_News_ID">
            ...
            <InsertParameters>
                ...
                <asp:Parameter Name="News_Mod_Date" DbType="Date" />
                <asp:Parameter Name="News_Mod_By" Type="Int32" />
                <asp:Parameter Name="News_Status" Type="Int32" />
            </InsertParameters>
            <SelectParameters>
                <asp:SessionParameter Name="param" SessionField="article_id" />
            </SelectParameters>
            <UpdateParameters>
                <asp:Parameter Name="News_Date" DbType="Date" />
                <asp:Parameter Name="News_Title" Type="String" />
