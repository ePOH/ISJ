<%@ Page Language="VB" MasterPageFile="ISJAdmin.master" AutoEventWireup="false" CodeFile="modify_user.aspx.vb" Inherits="admin_modify_user" %>
          ...
          <table style="width:1000px;">
                    ...
                    <tr>
                        ...
                        <td class="style4tb">
                            ...
                            &nbsp;</td>
                        <td class="style5tb">
                            <asp:Button ID="btn_muser" runat="server" Text="Select" /></td>
                    </tr>
                    <tr>
                        <td class="style1tb">
