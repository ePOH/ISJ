<%@ Page Language="VB" MasterPageFile="ISJAdmin.master" AutoEventWireup="false" CodeFile="modify_project_chooser.aspx.vb" Inherits="admin_modify_project_chooser" %>
                    ...
                    <tr>
                        ...
                        <td class="style4tb">
                            ...
                            <td class="style2tb">
                                &nbsp;</td>
                        <td class="style5tb">
                            <asp:Button ID="btn_mproject" runat="server" Text="Select" /></td>
                    </tr>
        </table>
        </p>
        </div>
