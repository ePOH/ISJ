<%@ Page Language="VB" AutoEventWireup="false" CodeFile="admin_login.aspx.vb" Inherits="admin_admin_login" %>
          ...
          <table style="width:1000px;">
                    ...
                    <tr>
                        ...
                        <td class="style4tb">
                            Password:</td>
                            <td class="style2tb">
                                <asp:RequiredFieldValidator ID="Val_Req_Password" runat="server" 
                        ErrorMessage="Password is Required!" ControlToValidate="login_password" 
                        ...
                        <td class="style5tb">
                            ...
                            <asp:TextBoxWatermarkExtender ID="login_password_TextBoxWatermarkExtender" 
                                runat="server" Enabled="True" TargetControlID="login_password" 
                                WatermarkText="********">
                            </asp:TextBoxWatermarkExtender>
                            <asp:PasswordStrength ID="login_password_PasswordStrength" runat="server" StrengthIndicatorType="BarIndicator" 
                                Enabled="True" TargetControlID="login_password" MinimumUpperCaseCharacters ="1" MinimumNumericCharacters="1"
                                 MinimumSymbolCharacters="1" RequiresUpperAndLowerCaseCharacters ="true" PreferredPasswordLength="12">
                    ...
                    <tr>
                        ...
                        <td class="style4tb">
                            ...
                            <td class="style2tb">
                                &nbsp;</td>
                        <td class="style5tb">
                            <asp:HyperLink ID="HL_F_Password" runat="server" NavigateUrl="~/admin/forgot_password.aspx">Forgot Your Password</asp:HyperLink></td>
                    </tr>
                    <tr>
                        <td class="style1tb">
                            &nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td class="style4tb">
                            ...
                            <td class="style2tb">
                                &nbsp;</td>
                        <td class="style5tb">
                            <asp:Button ID="btn_Login" runat="server" Text="Login" /></td>
                    </tr>
                    <tr>
                        <td class="style1tb">
                            &nbsp;</td>
